...
class AppLocalizationsBn extends AppLocalizations {
  ...
  String get aboutLine1 =>
      'এটি একটি ওপেন সোর্স প্রজেক্ট এবং এটির সোর্স কোড পাওয়া যাবে';
  ...
  String get disclaimerText =>
      'আমরা অন্য যে কোনো কিছুর চেয়ে আপনার গোপনীয়তাকে বেশি সম্মান করি। শুধুমাত্র আপনার নাম, যা আপনি এখানে লিখবেন, রাখা হবে। আপনার সমস্ত তথ্য আপনার ডিভাইসেই সংরক্ষণ করা হয়।';
  ...
  String get excludedDetails =>
      'নির্ধারিত ফোল্ডার থেকে সঙ্গীত প্রদর্শিত হবে না';
  ...
  String get includeExcludeFolderSub =>
      'নির্বাচিত ফোল্ডার যোগ/বাদ দিন \'আমার সঙ্গীত\' থেকে';
