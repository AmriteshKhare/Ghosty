...
import 'package:ghosty/Helpers/handle_native.dart';
import 'package:ghosty/Helpers/import_export_playlist.dart';
import 'package:ghosty/Helpers/logging.dart';
...
import 'package:ghosty/constants/constants.dart';
import 'package:ghosty/constants/languagecodes.dart';
import 'package:ghosty/providers/audio_service_provider.dart';
import 'package:ghosty/theme/app_theme.dart';
...
Future<void> main() async {
  ...
  if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
    await Hive.initFlutter('Ghosty/Database');
...
Future<void> openHiveBox(String boxName, {bool limit = false}) async {
  final box = await Hive.openBox(boxName).onError((error, stackTrace) async {
    ...
    if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
      dbFile = File('$dirPath/Ghosty/$boxName.hive');
      lockFile = File('$dirPath/Ghosty/$boxName.lock');
    }
    await dbFile.delete();
...
//     // );
//     // await HomeWidget.updateWidget(name: 'GhostyMusicWidget');
//   }
// }
...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    // HomeWidget.setAppGroupId('com.ghosty.app');
